                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className='nameAndEmail'>
                        <div className='singleField'>
                            ...
                            <input type="text"  placeholder='Krzysztof' value={this.state.name} name='name' onChange={this.handleChange}/>
                        ...
                        <div className='singleField'>
                            ...
                            <input type="text" placeholder='abc@xyz.pl' value={this.state.email} name='email' onChange={this.handleChange}/>
                    ...
                    <textarea rows="4" placeholder='Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sit amet nibh massa. Nullam blandit, felis sed tincidunt porta, mi urna facilisis est, eu varius leo tortor sit amet ex. Nulla et ullamcorper felis, dictum molestie mi.' value={this.state.message} name='message' onChange={this.handleChange}/>
